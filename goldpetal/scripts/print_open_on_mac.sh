...
print_open_on_mac() {
  ...
  echo
  echo "  2) Replace the Desktop file with v51 (~ window says Gold Petal v51):"
  ...
  echo "  Do not put chmod on the gcloud line. The window must say Gold Petal v51, not v50."
  echo
