...
print_open_on_mac() {
  ...
  echo
  echo "  2) Replace the Desktop file with v49 (~ window says Gold Petal v49):"
  ...
  echo "  Do not put chmod on the gcloud line. The window must say Gold Petal v49, not v48."
  echo
