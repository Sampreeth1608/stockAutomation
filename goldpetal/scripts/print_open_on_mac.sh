...
print_open_on_mac() {
  ...
  echo
  echo "  2) Replace the Desktop file with v47 (~ window says Gold Petal v47):"
  ...
  echo "  Do not put chmod on the gcloud line. The window must say Gold Petal v47, not v46."
  echo
