...
print_open_on_mac() {
  ...
  echo
  echo "  2) Replace the Desktop file with v60 (~ window says Gold Petal v60):"
  ...
  echo "  Do not put chmod on the gcloud line. The window must say Gold Petal v60, not v59."
  echo
  ...
  echo "     http://127.0.0.1:8501/?v=60     Gold Petal desk — gold v60 badge next to the title"
