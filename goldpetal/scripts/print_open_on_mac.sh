...
print_open_on_mac() {
  ...
  echo
  echo "  2) Replace the Desktop file with v40 (~ window says Gold Petal v40):"
  ...
  echo "  Do not put chmod on the gcloud line. The window must say Gold Petal v40, not v39."
  echo
