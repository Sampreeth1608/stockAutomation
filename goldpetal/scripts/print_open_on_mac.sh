...
print_open_on_mac() {
  ...
  echo
  echo "  2) Replace the Desktop file with v46 (~ window says Gold Petal v46):"
  ...
  echo "  Do not put chmod on the gcloud line. The window must say Gold Petal v46, not v45."
  echo
