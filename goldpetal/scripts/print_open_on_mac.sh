...
print_open_on_mac() {
  ...
  echo
  echo "  2) Replace the Desktop file with v42 (~ window says Gold Petal v42):"
  ...
  echo "  Do not put chmod on the gcloud line. The window must say Gold Petal v42, not v41."
  echo
