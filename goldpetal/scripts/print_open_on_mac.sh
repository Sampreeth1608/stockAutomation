...
print_open_on_mac() {
  ...
  echo
  echo "  2) Replace the Desktop file with v41 (~ window says Gold Petal v41):"
  ...
  echo "  Do not put chmod on the gcloud line. The window must say Gold Petal v41, not v40."
  echo
