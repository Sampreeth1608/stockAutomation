...
print_open_on_mac() {
  ...
  echo
  echo "  2) Replace the Desktop file with v66 (~ window says Gold Petal v66):"
  ...
  echo "     Do not put chmod on the gcloud line. The window must say Gold Petal v66, not v65."
  echo
  ...
  echo "     http://127.0.0.1:8501/?v=66     Gold Petal desk — gold v66 badge next to the title"
