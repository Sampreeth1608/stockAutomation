...
print_open_on_mac() {
  ...
  echo
  echo "  2) Replace the Desktop file with v59 (~ window says Gold Petal v59):"
  ...
  echo "  Do not put chmod on the gcloud line. The window must say Gold Petal v59, not v58."
  echo
  ...
  echo "     http://127.0.0.1:8501/?v=59     Gold Petal desk — gold v59 badge next to the title"
