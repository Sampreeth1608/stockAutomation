...
print_open_on_mac() {
  ...
  echo
  echo "  2) Replace the Desktop file with v50 (~ window says Gold Petal v50):"
  ...
  echo "  Do not put chmod on the gcloud line. The window must say Gold Petal v50, not v49."
  echo
