...
print_open_on_mac() {
  ...
  echo
  echo "  2) Replace the Desktop file with v52 (~ window says Gold Petal v52):"
  ...
  echo "  Do not put chmod on the gcloud line. The window must say Gold Petal v52, not v51."
  echo
