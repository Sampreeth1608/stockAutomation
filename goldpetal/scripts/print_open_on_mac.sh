...
print_open_on_mac() {
  ...
  echo
  echo "  2) Replace the Desktop file with v43 (~ window says Gold Petal v43):"
  ...
  echo "  Do not put chmod on the gcloud line. The window must say Gold Petal v43, not v42."
  echo
