...
print_open_on_mac() {
  ...
  echo
  echo "  2) Replace the Desktop file with v58 (~ window says Gold Petal v58):"
  ...
  echo "  Do not put chmod on the gcloud line. The window must say Gold Petal v58, not v57."
  echo
  ...
  echo "     http://127.0.0.1:8501/?v=58     Gold Petal desk — gold v58 badge next to the title"
