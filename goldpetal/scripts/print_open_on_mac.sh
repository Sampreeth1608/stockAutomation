...
print_open_on_mac() {
  ...
  echo
  echo "  2) Replace the Desktop file with v36 (~ window says Gold Petal v36):"
  ...
  echo "  Do not put chmod on the gcloud line. The window must say Gold Petal v36, not v35."
  echo
