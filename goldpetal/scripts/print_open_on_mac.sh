...
print_open_on_mac() {
  ...
  echo
  echo "  2) Replace the Desktop file with v48 (~ window says Gold Petal v48):"
  ...
  echo "  Do not put chmod on the gcloud line. The window must say Gold Petal v48, not v47."
  echo
