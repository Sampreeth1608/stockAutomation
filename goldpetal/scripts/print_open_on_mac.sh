...
print_open_on_mac() {
  ...
  echo
  echo "  2) Replace the Desktop file with v56 (~ window says Gold Petal v56):"
  ...
  echo "  Do not put chmod on the gcloud line. The window must say Gold Petal v56, not v55."
  echo
  ...
  echo "     http://127.0.0.1:8501/?v=56     Gold Petal desk — gold v56 badge next to the title"
