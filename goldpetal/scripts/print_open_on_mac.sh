...
print_open_on_mac() {
  ...
  echo
  echo "  2) Replace the Desktop file with v44 (~ window says Gold Petal v44):"
  ...
  echo "  Do not put chmod on the gcloud line. The window must say Gold Petal v44, not v43."
  echo
