...
print_open_on_mac() {
  ...
  echo
  echo "  2) Replace the Desktop file with v53 (~ window says Gold Petal v53):"
  ...
  echo "  Do not put chmod on the gcloud line. The window must say Gold Petal v53, not v52."
  echo
