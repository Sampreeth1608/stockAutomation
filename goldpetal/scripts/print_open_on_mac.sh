...
print_open_on_mac() {
  ...
  echo
  echo "  2) Replace the Desktop file with v45 (~ window says Gold Petal v45):"
  ...
  echo "  Do not put chmod on the gcloud line. The window must say Gold Petal v45, not v44."
  echo
