...
print_open_on_mac() {
  ...
  echo
  echo "  2) Replace the Desktop file with v57 (~ window says Gold Petal v57):"
  ...
  echo "  Do not put chmod on the gcloud line. The window must say Gold Petal v57, not v56."
  echo
  ...
  echo "     http://127.0.0.1:8501/?v=57     Gold Petal desk — gold v57 badge next to the title"
