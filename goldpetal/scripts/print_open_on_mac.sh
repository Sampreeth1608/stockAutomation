...
print_open_on_mac() {
  ...
  echo
  echo "  2) Replace the Desktop file with v61 (~ window says Gold Petal v61):"
  ...
  echo "     Do not put chmod on the gcloud line. The window must say Gold Petal v61, not v60."
  echo
  ...
  echo "     http://127.0.0.1:8501/?v=61     Gold Petal desk — gold v61 badge next to the title"
