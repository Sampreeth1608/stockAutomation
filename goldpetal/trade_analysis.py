...
WHAT_IT_GUESSES = {
    ...
    "S13_HHHL_DAY": "S16 close-vs-prev on the day candle, last 15m of that day (not next open). Up close: HH+green LONG / LL+red SHORT. Down close: wick (gap 0). FLIP. No fakeout / min_range.",
