...
WHAT_IT_GUESSES = {
    ...
    "OVERNIGHT_GAP": "Read today's Gold Petal tape near MARKET_CLOSE (day return, close in the day's range, last 45m return, late TBQ/TSQ). BUY if that read says tomorrow's open is up; SHORT if it says down; skip if mixed. CLOSE in the first 5 minutes after next MARKET_OPEN (09:00–09:05 IST). Independent of mood/regime. Not S4 daily swing. Not S7. ENABLE_OVERNIGHT_GAP defaults false. Paper until closed trades and WR% AC ≥ 40, then Live tab — you Arm live.",
