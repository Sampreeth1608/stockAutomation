...
WHAT_IT_GUESSES = {
    ...
    "S18_OHLC_VOL_HTF": "Wait for the 1h to finish. Base AND: green/red + close vs prev + HH/LL + volume up + close vs yesterday. Learner may change that pack from ticks (OHLC, volume, TBQ/TSQ, n_ticks). FLIP. Delivery — holds overnight. Only S16 flattens at MARKET_CLOSE. Paper only, not live.",
