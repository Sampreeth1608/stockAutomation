...
WHAT_IT_GUESSES = {
    ...
    "FLOW_BRAIN": "Tick LTP + TBQ + TSQ pressure. LONG when price and buy-flow expand together. SHORT the sell-flow mirror. No trade on absorption. Gate packs (confirm/min-hold/no-flip/persist/quality) sit on top of v1. Paper-wired, ENABLE_FLOW_BRAIN defaults false. Not S7_HOURLY. Not S16. Not live.",
