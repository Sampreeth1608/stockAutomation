...
WHAT_IT_GUESSES = {
    ...
    "S16_HHHL_WICK_1H": "Wait for the 1h candle to finish. Up close: HH+green LONG / LL+red SHORT. Down close: wick (gap 0) — upper wick SHORT, lower wick BUY. FLIP at that close. Mood Fit does not veto this 1h. Intraday only: flatten at MARKET_CLOSE, leftover at next open. Never overnight.",
